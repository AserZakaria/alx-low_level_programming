...
/**
 * check_elf - It Checks if a file is ELF file.
 * @e_ident: An pointer to an array containing the ELF magic numbers.
 *
 ...
 * @e_ident: An pointer to an array containing the ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf("  Class:                             ");
 ...
 * @e_ident: An pointer to an array containing the ELF version.
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
 ...
 * @e_ident: An pointer to an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_ident)
{
